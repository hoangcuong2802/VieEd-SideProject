...
namespace Supercyan.FreeSample
{
    public class FreeCameraLogic : MonoBehaviour
    {
        ...
        [SerializeField] public List<Transform> m_targets = null;
        ...
        private void Update()
        {
            ...
            {
                //m_currentTarget = GameObject.FindGameObjectWithTag("MainActor").transform;
                //m_currentTarget.transform.GetChild(0).GetComponent<TMP_Text>().text = Runner.LocalPlayer.ToString();
            }
